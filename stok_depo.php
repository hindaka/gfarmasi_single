    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <?php if (isset($_GET['status']) && ($_GET['status'] == "1")) { ?><div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <center>
                        <h4><i class="icon fa fa-check"></i>Berhasil!</h4>Data Stok Awal Obat telah diinput
                    </center>
                </div>
            <?php } else if (isset($_GET['status']) && ($_GET['status'] == "2")) { ?><div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                    <center>
                        <h4><i class="icon fa fa-check"></i>Berhasil!</h4>Data Stok Awal Obat berhasil dibatalkan
                    </center>
                </div>
            ...
            <section class="content-header">
                <h1>
                    Pengaturan
                    <small>Stok awal depo</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.php"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li>Pengaturan</li>
                    <li class="active">Stok awal depo</li>
                </ol>
            </section>
            <!-- Main content -->
            <section class="content">
                <div class="alert alert-info">Pilih Warehouse yang akan diatur stok awal barangnya</div>

                <!-- left column -->
                <div class="box box-primary">
                    <div class="box-header">
                        <i class="fa fa-user"></i>
                        <h3 class="box-title">Pengaturan Stok Awal Obat/BMHP di Warehouse</h3>
                    </div><!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="stok_depo_set.php" method="GET">
                        <div class="box-body">
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-md btn-primary"><i class="fa fa-send"></i> Proses</button>
                        </div>
                    </form>
                </div>
