        ...
        $(function() {
            ...
            var master_obat = $('#example1').DataTable({
                ...
                "columns": [{
                        ...
                        "data": null,
                        "render": function(data, type, full, meta) {
                            let btn_reff = data.old_id_ref + '<br><button id="id' + data.id_obat + '" onclick="loadForm(this)" data-id_obat = "' + data.id_obat + '" data-reff="' + data.old_id_ref + '" class="btn btn-xs bg-purple"><i class="fa fa-pencil"></i></button>';
                            return btn_reff;
                        }
                    },
                    {
