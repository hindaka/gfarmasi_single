...
$id_bentuk = isset($_GET['bentuk_sediaan']) ? trim($_GET['bentuk_sediaan']) : '';
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
					<div class="alert alert-info">Data digenerate pada tanggal <?php echo date('d-m-Y'); ?></div>

			  <!-- left column -->
			  <div class="box box-primary">
            <div class="box-header">
              <i class="fa fa-user"></i>
		  			<h3 class="box-title">Form SO <?php echo $jenis; ?> - <?php echo ucwords($head['nama_bentuk']); ?></h3>
						<a href="count_cycle_export.php?jenis=<?php echo $jenis; ?>&bentuk=<?php echo $id_bentuk; ?>" class="btn btn-sm btn-success pull-right"><i class="fa fa-download"></i> Export to Excel</a>
            </div><!-- /.box-header -->
						<div class="box-body">
