...
if($hitung=='keseluruhan'){
	$data_warehouse = $db->query("SELECT ws.id_obat,SUM(ws.stok) as total_stok,g.nama,g.jenis,g.sumber FROM `warehouse_stok` ws INNER JOIN gobat g ON(g.id_obat=ws.id_obat) GROUP BY id_obat");
	$ware = $data_warehouse->fetchAll(PDO::FETCH_ASSOC);
}elseif($hitung=='sebagian'){
        ...
        <section class="content">
          ...
          <div class="box-header">
            <i class="fa fa-user"></i>
	  				<h3 class="box-title">Data Stok Obat <?php echo ucwords($hitung); ?> Warehouse (<?php echo $id_warehouse; ?>)</h3>
						<a href="#" class="btn btn-md btn-success pull-right"><i class="fa fa-download"></i> Export to Excel</a>
          </div><!-- /.box-header -->
					<div class="box-body">
