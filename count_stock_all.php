      ...
      <section class="content">
        ...
        <div class="box box-primary">
          <div class="box-header">
            ...
            <h3 class="box-title">Data Stok Obat Keseluruhan Warehouse</h3>
            <a href="export_stock_all.php" target="_blank" class="btn btn-md btn-success pull-right"><i class="fa fa-download"></i> Export to Excel</a>
          </div><!-- /.box-header -->
          <div class="box-body">
            <div class="table-responsive">
              <table id="myTable" class="table table-bordered table-hover table-striped display" width="100%">
                <thead>
                  <tr class="info">
                    <th></th>
                    <th>#</th>
    ...
    $(document).ready(function() {
      ...
      function format(rowData) {
        ...
        $.ajax({
          ...
          dataType: 'json',
          success: function(e) {
            div.html(e).removeClass('loading');
          }
        });
        return div;
      }
