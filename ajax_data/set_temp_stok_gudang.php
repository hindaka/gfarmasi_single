...
try {
    ...
    if ($total_data > 0) {
        ...
        $ins = $db->prepare("INSERT INTO `temp_stok_awal`(`id_obat`, `id_warehouse`,`volume`,`harga_beli`, `no_batch`, `expired`,`merk`,`sumber_dana`,`e_kat`,`jenis`,`pabrikan`) VALUES(:id_obat,:id_warehouse,:volume,:harga_beli,:no_batch,:expired,:merk,:sumber_dana,:e_kat,:jenis,:pabrikan)");
