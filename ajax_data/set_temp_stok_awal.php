...
try {
    ...
    if ($total_data > 0) {
        ...
        $ins = $db->prepare("INSERT INTO `temp_stok_awal`(`id_obat`, `id_warehouse`,`volume`,`harga_beli`, `no_batch`,`ppn_tipe`, `expired`,`merk`,`sumber_dana`,`e_kat`,`jenis`,`pabrikan`, `tuslah`,`alasan`) VALUES(:id_obat,:id_warehouse,:volume,:harga_ppn,:no_batch,:ppn_tipe,:expired,:merk,:sumber_dana,:e_kat,:jenis,:pabrikan,:tuslah,:alasan)");
        ...
        $ins->bindParam(":ppn_tipe", $ppn_tipe);
        ...
        $ins->bindParam(":e_kat", $e_kat, PDO::PARAM_STR);
