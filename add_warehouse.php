        ...
        <div class="row">
          <div class="col-md-6 col-xs-12">
            <div class="box">
              ...
              <form class="" action="add_warehouse_acc.php" method="post">
                <div class="box-body">
                  <div class="form-group">
                    <label for="nama_ruang">Nama Ruangan <span style="color:red;">*</span></label>
                    <input type="text" name="nama_ruang" class="form-control" id="nama_ruang" placeholder="Masukan Nama Ruang" required>
                  </div>
                  <div class="form-group">
                    <label for="">Lokasi <span style="color:red;">*</span></label>
                    <input type="text" name="lokasi" id="lokasi" class="form-control" placeholder="Masukan Lokasi/Tempat" required>
                  </div>
                  <div class="form-group">
                    <label for="">Tipe Depo/Warehouse <span style="color:red;">*</span></label><br>
                    <input type="radio" name="tipe_depo" id="tipe_depo1" value="depo_set" required> Kelola Depo
