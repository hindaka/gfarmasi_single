...
$get_sediaan = $db->query("SELECT * FROM gobat_bentuk_sediaan ORDER BY nama_bentuk ASC");
$sediaan = $get_sediaan->fetchAll(PDO::FETCH_ASSOC);
?>
<!DOCTYPE html>
<html>
  <head>
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
			  ...
			  <div class="box">
				...
				<!-- form start -->
                <form role="form" action="count_cycle_acc.php" method="GET">
                  <div class="box-body">
										<div class="row">
											<div class="col-md-6">
											...
											<div class="col-md-6">
												<div class="form-group">
												  ...
												  <select class="form-control" name="bentuk_sediaan" id="bentuk_sediaan" required>
														<option value="">---Pilih Bentuk Sediaan---</option>
														<?php
															foreach ($sediaan as $s) {
																echo '<option value="'.$s['id_bentuk_sediaan'].'">'.$s['nama_bentuk'].'</option>';
															}
														?>
												  </select>
												</div>
