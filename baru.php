      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li>Tambah</li><li class="active">Data Obat</li>
          </ol>
        </section>
        ...
        <section class="content">
          ...
          <div class="box">
				...
				<!-- form start -->
                <form role="form" action="baruacc.php" method="post">
                  <div class="box-body">
            ...
            <input type="text" class="form-control" id="kemasan" name="kemasan" placeholder="Kemasan" required>
              ...
              <input type="text" class="form-control" id="satuan" name="satuan" placeholder="Satuan" required>
					...
					<!-- <div class="form-group">
					  <label for="bentuk">BENTUK <span style="color:red;">*</span></label>
					  <input type="text" class="form-control" id="bentuk" name="bentuk" placeholder="Bentuk" required>
					</div> -->
					<div class="form-group">
            <label for="pabrik">PABRIKAN/PRODUSEN <span style="color:red;">*</span></label>
            <input type="text" class="form-control" id="pabrik" name="pabrik" placeholder="Pabrikan" required>
          </div>
					<div class="form-group">
            ...
            <select class="form-control" name="sumber" required>
              ...
              <option value="BLUD">BLUD</option>
					...
					<div class="form-group">
            <label for="e_katalog">E-KATALOG <span style="color:red;">*</span></label>
            <select class="form-control" name="e_katalog" required>
							<option value="">Pilih E-Katalog</option>
            ...
            <select class="form-control" name="formularium" required>
              ...
              <option value="tidak">Tidak</option>
					...
					<div class="form-group">
					  <label for="precusor">PRECUSOR <span style="color:red;">*</span></label>
					  <select class="form-control" name="precusor" required>
							<option value="">Pilih PRECUSOR</option>
							<option value="ya">Ya</option>
							<option value="tidak">Tidak</option>
					  </select>
					</div>
